...
\begin{table}[!h]
	...
	\small\begin{tabular}{c|ccc|ccc|ccc}
		...
		\midrule
		PCA & 0.775 & 0.481 & 0.653 & 0.759 & 0.513 & 0.623 & 0.775 & 0.481 & 0.653 \\
		基准自编码器 & 0.840 & 0.837 & 0.872 & 0.756 & 0.498 & 0.628 & 0.746 & 0.466 & 0.575 \\
		自编码器+对比学习 & \textbf{0.866} & \textbf{0.916} & \textbf{0.926} & \textbf{0.958} & \textbf{0.979} & \textbf{0.991} & \textbf{0.823} & \textbf{0.722} & \textbf{0.786} \\
		\bottomrule
	\end{tabular}
	\label{tab:results}
\end{table}
